...
<template>
  <Card class="mt-[5vh]" style="overflow: hidden">
    ...
    <template #content>
      <InputsRequerimiento  @update:cod="updateCod" @update:salarioMax="updateSalarioMax" @update:salarioMin="updateSalarioMin" @update:nVacantes="updateNVacantes" @update:descfuncion="updateDescfuncion" @update:descCarreras="updateDescCarreras" @update:FechaReque="updateFechaReque"/>
    </template>
    <template #footer>
