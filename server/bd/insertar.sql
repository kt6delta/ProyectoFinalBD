...
INSERT INTO TIPODOC(IDTIPODOC,DESCTIPODOC) VALUES ('1','Cedula');
INSERT INTO TIPODOC(IDTIPODOC,DESCTIPODOC) VALUES ('2','Cedula Extranjeria ');
INSERT INTO TIPODOC(IDTIPODOC,DESCTIPODOC) VALUES ('3','Pasaporte');

--institucion
INSERT INTO INSTITUCION(CODINSTITUCION,NOMINSTITUCION) VALUES (1,'u distrital');
INSERT INTO INSTITUCION(CODINSTITUCION,NOMINSTITUCION) VALUES (2,'u javeriana');
INSERT INTO INSTITUCION(CODINSTITUCION,NOMINSTITUCION) VALUES (3,'u de los andes');

----
INSERT INTO CANDIDATO(USUARIO,IDTIPODOC, NOMBRE, APELLIDO, FECHANAC, NDOC) VALUES ('alejandro','1', 'alejandro','Bustamante',TO_DATE('2024-02-16', 'YYYY-MM-DD'), 266304481);
INSERT INTO CANDIDATO(USUARIO,IDTIPODOC, NOMBRE, APELLIDO, FECHANAC, NDOC) VALUES ('camilo','1', 'camilo','Becerra',TO_DATE('2024-02-19', 'YYYY-MM-DD'), 102959);
INSERT INTO CANDIDATO(USUARIO,IDTIPODOC, NOMBRE, APELLIDO, FECHANAC, NDOC) VALUES ('josue','1', 'josue','Gomez',TO_DATE('2024-02-20', 'YYYY-MM-DD'), 9285877);
INSERT INTO CANDIDATO(USUARIO,IDTIPODOC, NOMBRE, APELLIDO, FECHANAC, NDOC) VALUES ('luis','1', 'luis','Vargas',TO_DATE('2024-02-17', 'YYYY-MM-DD'), 78842336);

--Hoja de vida

INSERT INTO HV (CONSECHV,USUARIO, CODINSTITUCION,IDTIPOITEMPERFIL ,FECHAINICACT,FECHAFINACT, DESCACTIVIDAD,FUNCIONACTIVIDAD) VALUES (1,'alejandro',1,'3',TO_DATE('2024-02-19', 'YYYY-MM-DD'),TO_DATE('2024-02-25', 'YYYY-MM-DD'),'desarrollo web','ingeniero sistemas');
INSERT INTO HV (CONSECHV,USUARIO, CODINSTITUCION,IDTIPOITEMPERFIL ,FECHAINICACT,FECHAFINACT, DESCACTIVIDAD,FUNCIONACTIVIDAD) VALUES (2,'camilo',2,'2',TO_DATE('2024-02-19', 'YYYY-MM-DD'),TO_DATE('2024-02-25', 'YYYY-MM-DD'),'desarrollo web','ingeniero sistemas');
INSERT INTO HV (CONSECHV,USUARIO, CODINSTITUCION,IDTIPOITEMPERFIL ,FECHAINICACT,FECHAFINACT, DESCACTIVIDAD,FUNCIONACTIVIDAD) VALUES (3,'luis',3,'1',TO_DATE('2024-02-19', 'YYYY-MM-DD'),TO_DATE('2024-02-25', 'YYYY-MM-DD'),'desarrollo web','ingeniero sistemas');
